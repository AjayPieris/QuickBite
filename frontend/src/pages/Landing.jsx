...
function Typewriter() {
  ...
  return (
    <span className="text-[#f97316]">
      ...
      <span
        className="inline-block w-0.5 h-6 md:h-8 bg-[#f97316] ml-1 align-middle"
  ...
  const features = [
    {
      ...
      desc: "Order in seconds, pick up in minutes. No more standing in long queues.",
    },
    {
      icon: "📱",
      title: "Mobile Friendly",
      desc: "Order from anywhere on campus with our responsive web app.",
    },
    {
      icon: "🔔",
      title: "Real-time Updates",
      desc: "Get notified instantly when your order is ready for pickup.",
    },
    {
      icon: "🤖",
      title: "AI Insights",
      desc: "Smart analytics help the canteen optimize prep times and menus.",
    },
    {
      icon: "🔒",
    ...
    },
    {
      icon: "📊",
      title: "Order History",
      desc: "Track all your past orders and reorder your favorites easily.",
    },
  ];
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
          ...
          >
            ...
            {/* Typewriter subtitle */}
            <p className="text-xl md:text-2xl text-[#9ca3af] mb-12 h-14 flex items-center justify-center">
              <Typewriter />
            </p>
        ...
        {/* Scroll Down Indicator - Moved directly to Hero section */}
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        >
          <a
            href="#stats"
            className="flex flex-col items-center gap-2 text-[#9ca3af] hover:text-white transition-colors"
          >
          ...
          <ScrollReveal>
            <div className="text-center mb-16">
              ...
              <p className="text-[#9ca3af] text-lg max-w-2xl mx-auto">
                Everything you need for a seamless canteen experience, powered
      ...
      <footer className="block py-10 px-4 border-t border-white/5 relative">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <p className="text-[#9ca3af] text-sm">
            © 2026 QuickBite. Built with ❤️ for hungry students.
          </p>
        </div>
      </footer>
    </PageTransition>
